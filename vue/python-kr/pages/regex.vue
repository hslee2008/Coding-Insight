<template>
  <div>
    ...
    <div
      style="
        display: flex;
        background-color: rgb(51, 197, 143);
        padding: 10px;
        color: black;
        border-radius: 5px;
      "
    >
      <div style="margin: auto">
        ...
        <p>
          ...
          뜻합니다.<br /><br />
          정규식 없이 영어에서 모든 알파벳의 문자를 만들고 싶다면 'abcdef...'
    ...
    <div>
      <div>
        <h1>정규식 - 문자의 값 맞히기</h1>
        <p>
          re.match() 메서드를 사용하면 어떤 두 문자에서 동일한 시작 부분을 알 수
          있습니다.
        </p>
      </div>
    </div>
    ...
    <div>
      <div>
        <div>
          <h1>정규식 - 문자의 값 찾기</h1>
          <p>
            match는 문자의 시작 부분을 알 수 있지만 re.search() 메서드를
            사용한다면 전체 값에서의 같은 부분을 계산할 수 있습니다.
          </p>
        </div>
      </div>
      <iframe
    ...
    <div>
      <div>
        ...
        <p>
          ...
          2. [abc]: a, b, 또는 c<br />
          3. [^abc]: a, b, c 제외<br />
          &nbsp;. -- 임의의 알파벳: "h."는 ha, hb, hc, ... hz 다입니다<br />
          &nbsp;^ -- 단어 중 다음 패턴으로 시작하는지: "^hello": hello로
          시작하는 단어가 있는지<br />
          &nbsp;$ -- 단어 중 다음 패턴으로 끝나는지: "$hello": hello로 끝나는
          단어가 있는지
        </p>
      </div>
    </div>
    ...
    <BeforeNextButton flink="random" slink="class"></BeforeNextButton>
