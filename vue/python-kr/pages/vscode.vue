<template>
  <div>
    ...
    <div class="text-center">
      ...
      <br /><br />
      <h1 class="display-6">
        <span id="tit">VSCode 설치</span><br id="lbbr" /><span id="txt"
          >Computer Science Lab (</span
        >CSL<span id="txt">)</span> 3
      </h1>
      <br />
      <hr />
    </div>
    ...
    <div>
      ...
      <div style="display: flex; padding: 30px; border-radius: 5px">
        <div class="sub-div">
          <h1>.py?</h1>
          <p>
            위의 설명에서 항상 파이썬 파일을 만들때 "이름.py" 형태로
            정해야한다고 했습니다.
          </p>
          <br />
          <p>
          ...
          <br />
          <p>
            .py는 python의 약자로 컴퓨터에게 우리가 만든 파일이 파이썬
            파일이라고 알려줍니다.
          </p>
        </div>
      ...
      <div style="margin: 20px; padding: 20px">
        <a href="install" style="text-decoration: none; float: left">
          <v-btn class="ma-2" outlined>
            <v-icon left> mdi-chevron-left </v-icon>Back
          </v-btn>
        </a>

        <a href="io" style="text-decoration: none; float: right">
          <v-btn class="ma-2" outlined>
