<template>
   <div>
      ...
      <div class="text-center">
         <iframe width="560" height="315" src="https://www.youtube.com/embed/OrWWnx2ydHc" title="YouTube video player"
            frameborder="0"
      ...
      <div>
         ...
         <iframe src="https://trinket.io/embed/python3/a413df3b12" width="100%" height="356" frameborder="0"
      ...
      <div>
         ...
         <iframe src="https://trinket.io/embed/python3/d50ab693f8" width="100%" height="356" frameborder="0"
            marginwidth="0" marginheight="0" allowfullscreen loading="lazy" style="margin: auto;"></iframe>
      </div>
      ...
      <div>
         ...
         <iframe src="https://trinket.io/embed/python3/8ea821b7b4" width="100%" height="356" frameborder="0"
            marginwidth="0" marginheight="0" allowfullscreen loading="lazy" style="margin: auto;"></iframe>
      </div>
      ...
      <div>
         <div>
            <h1>다른 메서드</h1>
            <p>
            <h4>리스트에서 값이 나타나는 개수 찾기</h4>
            리스트에서 'blue'라는 값이 나타나는 개수를 찾기 위하여 'count()'를 CODE1에서 사용해보겠습니다.<br /><br />
            <h4>리스트 값의 인덱스 찾기</h4>
            리스트에서 값의 인덱스를 찾을 수도 있습니다. CODE2와 같이 'Poo'라는 단어의 인덱스를 찾아보겠습니다.<br /><br />
            <h4>리스트에서 모든 값 더하기</h4>
            sum() 함수를 사용하면 리스트에 있는 모든 숫자를 더한 값을 찾을 수 있습니다 (CODE3)
            </p>
         </div>
         <iframe src="https://trinket.io/embed/python3/7fdd2b43c1" width="100%" height="356" frameborder="0"
