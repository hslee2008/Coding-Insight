<template>
  <div>
    ...
    <div style="display: flex" class="img-div">
      <div style="margin: auto; padding: 10px">
        ...
        <p>
          ...
          일상생활에서의 사전은 단어와 그 단어에 대한 설명으로 이루어져
          있습니다.<br /><br />

          코딩에서도 파이썬 딕셔너리는
          <mark>키(key)와 값(value)의 한쌍이 여러개로 이루어진 데이터 형태</mark
          >를 뜻합니다.<br /><br />
    ...
    <div>
      <div>
        ...
        <p>
          ...
          딕셔너리 예를 살펴보겠습니다.<br /><br />

          옆의 예시에서 Key는 phonenumber, age, bestfriend이고 이 Key에 해당하는
    ...
    <div>
      <div>
        ...
        <p>
          ...
          keys()는 <a href="for.html">for 반복문</a>에서 더 유용하게 사용할 수
          있는 예시를 들겠습니다.
        </p>
      </div>
      <iframe
    ...
    <div>
      <a href="listmethod2" style="text-decoration: none; float: left">
        <v-btn class="ma-2" outlined>
          <v-icon left> mdi-chevron-left </v-icon>Back
        </v-btn>
      </a>

      <a href="dictionarymethod" style="text-decoration: none; float: right">
        <v-btn class="ma-2" outlined>
    ...
    <div class="quiz">
      ...
      <h3>print({"1": "a", "2": "b"}.keys()) 코드를 실행하면?</h3>
