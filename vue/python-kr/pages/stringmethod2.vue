      ...
      <div>
        <div>
          ...
          <p>
            ...
            또 다른 예시를 들어보겠습니다.<br /><br

            이 예시에서 name을 기준으로 잘랐습니다. partitionedSentence를
            출력하면 ("Hello. My ", "name", " is Hyunseung")가 터미널에 출력이
            되는 것을 관찰할 수 있습니다. 인덱싱을 사용하여 'name' 전의 문장과
            'name' 후의 문장을 결합했습니다.<br /><br />
          </p>
        </div>
        <iframe
