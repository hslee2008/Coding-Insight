<template>
  <div>
    ...
    <div style="display: flex" class="img-div">
      <div>
        ...
        <p>
          ...
          하지만, do - while은 코드를 먼저 실행하고 조건을 확인합니다.<br /><br />

          그래서 만일 조건이 맞더라 하더라도 코드를 먼저 실행하고 종료합니다.<br /><br />

          반면에, while은 조건을 먼저 확인하고 코드를 실행합니다. 그래서 조건이
          맞다면 바로 끝냅니다.
        </p>
      </div>
    ...
    <NaviBtn flink="doublefor" slink="inffor" />
