    ...
    <div>
      <div class="ma-auto">
        ...
        <p>
          ...
          언제 정확히 어디에서 코드를 끊을지 설정할 수 있는 키워드르 매우
          유용합니다.<br /><br />

          예를 들면, 0에서 9까지 반복하며 그 값을 출력할 것입니다. 하지만
          저번과는 조금 다르게 5에서 끊겠습니다.
        </p>
      </div>
      <div class="ma-auto">
        <iframe :src="`${jdoodle}3YMb`" width="100%" height="300px" />
      </div>
    </div>
    ...
    <div>
      <div>
        ...
        <p>
          ...
          하지만 이 키워드를 사용한다면 C의 반복문을 복잡하게 하거나 망칠 수
          있으니 break를 사용하세요.<br /><br />
