<template>
  <div>
    ...
    <div style="display: flex" class="img-div">
      <div>
        ...
        <p>
          ...
          휴지, 머리핀 등을 상자 안에 넣은 후 나중에 쉽게 상자 안에 있는
          아이템을 꺼내서 사용할 수 있습니다.<br /><br />

          변수란 상자와 비슷하게 나중에 쉽게 바꾸고, 삭제하고, 사용하게
          만들어주는 저장소를 뜻합니다.
        </p>
      </div>
      <div>
    ...
    <div>
      <div>
        ...
        <p>
          ...
          VARIABLE_NAME은 변수의 이름입니다. 상자의 이름 또는 번호를 요구하면 그
          안에 있는 아이템을 가지고 올 수 있습니다.<br /><br />

          이와 비슷하게 변수의 이름을 사용하면 변수의 값을 알 수 있습니다.<br /><br />
    ...
    <div>
      ...
      <div>
        <iframe
          src="https://www.jdoodle.com/embed/v0/3VTB"
          width="100%"
          height="300"
        />
      </div>
    ...
    <div>
      ...
      <div>
        <iframe
          src="https://www.jdoodle.com/embed/v0/3VTC"
          width="100%"
          height="500"
        />
      </div>
    ...
    <div>
      ...
      <div>
        <iframe
          src="https://www.jdoodle.com/embed/v0/3VTE"
          width="100%"
          height="300px"
        />
      </div>
