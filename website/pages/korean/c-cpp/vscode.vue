  ...
  <div>
    ...
    <div>
      <div>
        ...
        <br />
        <p>
          7. 새로운 터미널을 엽니다. 열려면 CTRL+`룰 누르거나 아래와 같이 버튼을
          누릅니다. <br />
        ...
        />
        <br />
        <p>6. gcc main.c(또는 C 언어 파일 이름)를 실행합니다.</p>

        <p>
          참고로 위의 커맨드를 실행하면 새로운 파일(a.exe)라고 생겼을 것입니다.
          확인하세요!
        </p>
    ...
    <div>
      <div>
        ...
        <p>
          ...
          3. printf("Hello, World!!");는 터미널에 Hello, World!!라고
          출력합니다.<br /><br />
