  ...
  <div>
    ...
    <div>
      <div>
        <h1>파일 다루는 작업이란?</h1>
        <p>
          파일을 다루는 작업은 파일 처리하는 작업입니다.<br /><br />
    ...
    <div>
      <div>
        <h1>FILE 데이터 형태</h1>
        <p>
          C 언어에서 파일을 먼저 변수 안에 저장해야 합니다.<br /><br />
    ...
    <div>
      <div>
        ...
        <p>
          ...
          fopen() 함수는 파일을 여는 함수입니다.<br /><br />

          매개변수로 첫 번째에는 파일 주소와 파일을 여는 모드를 넣습니다.<br /><br />
    ...
    <NaviBtn flink="math" slink="readfile" />
