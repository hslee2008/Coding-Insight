<template>
  <div>
    ...
    <div>
      <div>
        ...
        <p>
          ...
          무한 반복문을 원하지 않을 때가 대부분이지만 원하는 때도 있을 수 있기
          때문에 배우겠습니다.
        </p>
      </div>
      <div class="ma-auto">
    ...
    <div>
      <div class="ma-auto">
        ...
        <p>
          ...
          조건문을 이용하여 break하는 것도 가능합니다. break에 관한 내용은 다음
          시간에 배우겠습니다.
        </p>
      </div>
      <div class="ma-auto">
    ...
    <div>
      ...
      <div class="ma-auto">
        <iframe :src="`${jdoodle}3YM6`" width="100%" height="400px" />
      </div>
    </div>

    <Navigation bef="dowhile" aft="conbregot" />
  </div>
</template>
