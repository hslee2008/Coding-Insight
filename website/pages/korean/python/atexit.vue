<template>
  <div>
    ...
    <div style="display: flex" class="img-div">
      <div style="margin: auto; padding: 10px">
        ...
        <p>
          ...
          atexit 모듈을 사용하여 <mark>함수를 '등록'</mark>할 수 있습니다.<br /><br />
    ...
    <div>
      <div>
        ...
        <p>
          ...
          만일 프로그램이 실행되고 있어서 파일을 닫지 못하면 어떻게 될까요?<br /><br />

          파일을 아직 쓰고 있는데 <kbd>ctrl+c</kbd>를 누르면 에러가 생길 수
          있습니다.<br /><br />
    ...
    <iframe
      src="https://trinket.io/embed/python3/2390219212"
      width="100%"
      height="356"
      frameborder="0"
      marginwidth="0"
    ...
    <iframe
      src="https://trinket.io/embed/python3/ee9dc05bf9"
      width="100%"
      height="356"
      frameborder="0"
      marginwidth="0"
