<template>
  <div>
    ...
    <div>
      <div>
        ...
        <p>
          ...
          리스트에서는 인덱싱을 사용하여 새로운 값으로 바꿀 수 있지만 튜플에서는
          못합니다.<br /><br />

          그래서 파이썬 프로그램을 짜는데 절대로 사용자가 바꾸면 안 되는
          데이터들(예: 점수, 시험 성적, ...)을 튜플 안에 저장할 수 있습니다.<br /><br />
          ...
          CODE3와 같이 파이썬에서 신기하게도 () 없이도 튜플이라고 인식할 수 있는
          기능이 있습니다.
        </p>
      </div>
    ...
    <Header type="파이썬" title="튜플" num="24" />
    ...
    <div>
      <div>
        <h2>튜플 길이 지정하기</h2>
        <p>
          파이썬에서는 튜플의 길이를 미리 지정하여 나중에 소수로 값을 더하는
          행위를 막을 수 있습니다.<br /><br />
      ...
      <v-card-text>
        ...
        <div>
          <input
            ...
            name="question-2-answers"
          />
          <label for="question-2-answers-D"> 다른 정답 </label>
        </div>
