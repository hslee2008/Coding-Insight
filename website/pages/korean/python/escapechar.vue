<template>
  <div>
    ...
    <br />
    <mark
      >참고할 내용: 컴퓨터에 따라 W와 선이 그어진 모양으로 보일 수 있고 / 옆으로
    ...
    <div>
      <div>
        ...
        <p>
          ...
          더 흔한 사용은 저번에 있는 문자를 지우고 새로운 문자를 넣는
          방법입니다.<br /><br />
