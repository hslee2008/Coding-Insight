    ...
    <div style="display: flex; margin: auto" class="img-div">
      <div style="margin: auto">
        ...
        <p>
          ...
          비슷하게 프로그래밍에서 우리의
          <mark>코드를 이해하는 것을 도와주기 위한 설명</mark>을 넣을 수
          있습니다.<br /><br />
        </p>
      </div>
    ...
    <div>
      <div>
        ...
        <p>
          ...
          '#' 다음에 나오는 문자들은 파이썬을 실행할 때
          <mark>영향을 주지 않습니다</mark>. 그 이유는 노트이기 때문에
          파이썬에서는 실행되지 않기 때문입니다.<br /><br />
