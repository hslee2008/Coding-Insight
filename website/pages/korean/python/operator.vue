   ...
   <div>
      ...
      <div style="display: flex" class="img-div">
         ...
         <div style="display: flex; justify-content: center;">
            <v-img
alt="python-factory-picture"      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAEJ9fzr3QpW7a9Ase_cE279O1pTyY4GZ2T4cXc7rXrugIqPf_586nsM-Ajo_Q0Qxuyxk&usqp=CAU"
               max-width="300px" />
         </div>
      </div>
      <br /><br />
...
width="80%" height="315" src="https://www.youtube.com/embed/sGZLq4VZW58" title="YouTube video player"
      ...
      <div>
         <div>
            <h1> 산수 연산자 </h1>
            <p>
               산수 연산자는 <NuxtLink to="./number">숫자</NuxtLink>에서 배웠습니다.<br /><br />
