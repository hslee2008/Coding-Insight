  ...
  <div>
    ...
    <div>
      <div class="ma-auto">
        ...
        <p>
          ...
          옆에 있는 예시를 보면 Hello와 World가 한 줄에 없어서 에러가 생긴
          것입니다.<br />
        </p>
      </div>
    ...
    <div>
      <div>
        <h2>문자 - 여러 줄</h2>
        <p>
          만일 문자와 문자 사이에 많은 줄이 있는 형태로 데이터를 출력하고 싶다면
          어떻게 할까요? <br /><br />
      ...
      <iframe :src="`${trinket2}c420acd5f8`" height="356" />
    </div>
    ...
    <div>
      <div>
        ...
        <p>
          문자에서 선택하고 싶은 한 장소의 정보를 찾아내는 작업을 인덱싱이라고
          하고 그 장소를 인덱스라고 합니다.<br /><br />
    ...
    <div>
      <div style="margin: 20px">
        ...
        <p>
          문자에서 어떤 범위의 부분 문자를 구하기 위하여 다음과 같은 방법을
          사용할 수 있습니다.<br /><br />
      ...
      <iframe :src="`${trinket2}47c742b3bd`" height="356" />
    </div>
    ...
    <div>
      ...
      <iframe :src="`${trinket2}4e95210044`" height="356" />
    </div>
