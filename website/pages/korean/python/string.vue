      ...
      <div style="display: flex" class="img-div">
        <div style="margin: auto;">
          ...
          <p>
            ...
            옆에 있는 예시를 보면 Hello와 World가 한 줄에 없어서 에러가 생긴 것입니다.<br />
          </p>
        </div>
      ...
      <div >
        <div>
          ...
          <p>
            ...
            를 출력하는 방법은 있을까요?<br /><br />

            다양한 방법이 있겠지만 3개 예시를 보겠습니다. <br /><br />

            4번째 방법을 보면 ''' '''를 사용했습니다.<br /><br />

            이 기호 안에 저희는 새로운 줄(enter)을 넣어서 사용할 수 있습니다. 하지만 ''와 ""에서는 새로운 줄을 사용할 수 없습니다.<br /><br />
      ...
      <div>
        <div>
          ...
          <p>
            ...
            예를 들어 Hello에서 첫 번째 문자를 출력하기 위해서 인덱스 0을 사용할 수 있습니다.<br /><br />
            ...
            문자 다음에 나오는 [] (대괄호) 안에 있는 숫자는 문자의 인덱스입니다.<br /><br />

            일상생활에서 '처음'이라고 하면 보통 1을 생각합니다.<br /><br />

            하지만 배열(문자열, 리스트 등)에서 첫 번째 인덱스를 출력하기 위해서 0을 사용합니다. 2번째는 1이고 3번째는 2입니다.<br /><br />
      ...
      <div>
        <div style="margin:20px;">
          ...
          <p>
            ...
            [] 안에 ':'를 사용하여 ':' 전에 나오는 인덱스를 포함하고 ':' 다음에 나오는 인덱스는 제외하고 출력이 됩니다.<br /><br />
      ...
      <div>
        <div>
          ...
          <p>
            ...
            옆의 예시에서 ::-1은 0:0:-1을 생략한 코드입니다.<br /><br />

            마지막 숫자는 스텝을 뜻합니다. 스텝은 문자 인덱싱을 셀때 단위입니다. 예를 들면, 단위를 2로 정하면 2 문자 중 하나씩만 출력됩니다.<br /><br />
...
src="https://trinket.io/embed/python/4e95210044" width="100%" height="356" frameborder="0"
      ...
      <div class="quiz">
        ...
        <div>
          <input id="question-1-answers-A" type="radio" name="question-1-answers" value="A" />
          <label for="question-1-answers-A">A) !문자! </label>
        </div>

        <div>
          <input id="question-1-answers-B" type="radio" name="question-1-answers" value="B" />
          <label for="question-1-answers-B">B) "문자" </label>
        </div>

        <div>
          <input id="question-1-answers-C" type="radio" name="question-1-answers" value="C" />
          <label for="question-1-answers-C">C) [문자] </label>
        </div>

        <div>
          <input id="question-1-answers-D" type="radio" name="question-1-answers" value="D" />
        ...
        <div>
          <input id="question-2-answers-A" type="radio" name="question-2-answers" value="A" />
          <label for="question-2-answers-A">A) ?문자? 사용 </label>
        </div>

        <div>
          <input id="question-2-answers-B" type="radio" name="question-2-answers" value="B" />
          <label for="question-2-answers-B">B) #문자 사용 </label>
        </div>

        <div>
          <input id="question-2-answers-C" type="radio" name="question-2-answers" value="C" />
          <label for="question-2-answers-C">C) """ 문자 """ 사용 </label>
        </div>

        <div>
          <input id="question-2-answers-D" type="radio" name="question-2-answers" value="D" />
        ...
        <div>
          <input id="question-3-answers-A" type="radio" name="question-3-answers" value="A" />
          <label for="question-3-answers-A">A) 0 </label>
        </div>

        <div>
          <input id="question-3-answers-B" type="radio" name="question-3-answers" value="B" />
          <label for="question-3-answers-B">B) 1 </label>
        </div>

        <div>
          <input id="question-3-answers-C" type="radio" name="question-3-answers" value="C" />
          <label for="question-3-answers-C">C) 2 </label>
        </div>

        <div>
          <input id="question-3-answers-D" type="radio" name="question-3-answers" value="D" />
        ...
        <div>
          <input id="question-4-answers-A" type="radio" name="question-4-answers" value="A" />
          <label for="question-4-answers-A">A) a[1:3] </label>
        </div>

        <div>
          <input id="question-4-answers-B" type="radio" name="question-4-answers" value="B" />
          <label for="question-4-answers-B">B) a[:4] </label>
        </div>

        <div>
          <input id="question-4-answers-C" type="radio" name="question-4-answers" value="C" />
          <label for="question-4-answers-C">C) a[:] </label>
        </div>

        <div>
          <input id="question-4-answers-D" type="radio" name="question-4-answers" value="D" />
        ...
        <div>
          <input id="question-5-answers-A" type="radio" name="question-5-answers" value="A" />
          <label for="question-5-answers-A">A) 0 </label>
        </div>

        <div>
          <input id="question-5-answers-B" type="radio" name="question-5-answers" value="B" />
          <label for="question-5-answers-B">B) -1 </label>
        </div>

        <div>
          <input id="question-5-answers-C" type="radio" name="question-5-answers" value="C" />
          <label for="question-5-answers-C">C) -2 </label>
        </div>

        <div>
          <input id="question-5-answers-D" type="radio" name="question-5-answers" value="D" />
