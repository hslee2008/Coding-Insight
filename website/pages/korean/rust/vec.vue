<template>
  <div>
    ...
    <p>
      ...
      Vec는 <code class="ic">Vec&lt;데이터></code>로 선언할 수 있습니다.
    </p>

    <Header type="Rust" title="Rust 백터" num="41" />
    ...
    <p>
      ...
      <code class="ic">vec![1, 2, 3, 4, 5]</code>

      Vec는 크기가 지정되지 않았기 때문에
      <code class="ic">.push()</code> 메서드나 <code class="ic">.pop()</code>를
      사용해 새로운 값을 <mark>끝</mark>에 추가하거나 <mark>끝</mark>의 값을
      제거할 수 있습니다.<br /><br />
    ...
    <h2>len() 메서드와 인덱스</h2>
    <p>
      <code class="ic">len()</code> 메서드를 사용하면 배열의 크기를 알 수
      있습니다.<br /><br />

      그리고 배열처럼 []를 사용해 사이에 숫자를 넣으면 그 인덱스에 있는 값을 알
      수 있습니다.<br /><br />

      그리고 <code class="ic">iter()</code>르 사용하면 각 아이템을 순서대로
      순회할 수 있습니다.<br /><br />

      마지막으로 iter할 때 값을 바꾸고 싶다면 항상
      <code class="ic">iter_mut()</code>를 사용하고 반환된 값 앞에 *르 붙여서
      값을 지정하세요.<br /><br />
    ...
    <h2>enumerate() 메서드</h2>
    <p>
      <code class="ic">enumerate()</code> 메서드를 사용하면 각 아이템을의
      인덱스와 값이 함께 순회할 수 있습니다.<br /><br />
      ...
      그리고 <code class="ic">enumerate()</code>를 사용하면
      <code class="ic">iter()</code>를 먼저 사용해야 됩니다.<br /><br />
