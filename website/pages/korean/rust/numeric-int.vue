<template>
  <div>
    ...
    <div>
      <div>
        <h2>Unsigned 정수</h2>
        unsigned 정수 변수는 양수만 저장할 수 있는 것을 뜻합니다.<br /><br />
          ...
          <template v-slot:default>
            <thead>
              <tr>
                ...
                <th class="text-left">최소값, 최대값</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="item in datatypes" :key="item.name">
                <td>{{ item.name }}</td>
                <td>{{ item.minmax }}</td>
              </tr>
            </tbody>
      ...
      <div>
        ...
        <v-simple-table>
          <template v-slot:default>
            ...
            <tbody>
              <tr v-for="item in datatypesi" :key="item.name">
                <td>{{ item.name }}</td>
                <td>{{ item.minmax }}</td>
              </tr>
            </tbody>
    ...
    <div>
      <div>
        ...
        그래서 <IC code="(숫자형태)::MIN" />를 출력하면 숫자형태의 최소값을
        출력합니다 (예: i8, i16 등).<br /><br />

        그래서 <IC code="(숫자형태)::MAX" />를 출력하면 숫자형태의 최소값을
        출력합니다 (예: i8, i16 등).<br /><br />
  ...
  data() {
    return {
      datatypes: [
        ...
        {
          name: 'u64',
          minmax: '0 ~ 18446744073709551615',
        },
        {
          name: 'u128',
          minmax: '0 ~ 340282366920938463463374607431768211455',
        },
      ],
      datatypesi: [
        {
