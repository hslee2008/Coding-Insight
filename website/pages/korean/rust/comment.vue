  ...
  <div>
    ...
    <div>
      <div>
        <h1>주석 달기 (한 줄)</h1>
        <p>
          <IC code="//" />를 사용하면 그 줄에서 이 다음으로 나오는 모든 글자들은
          다 주석으로 변합니다.<br /><br />
    ...
    <div>
      <div>
        <h1>주석 달기 (블록 줄)</h1>
        <p>
          <IC code="//" />는 그 줄에서 이 다음으로 나오는 모든 글자들은 다
          주석으로 만들지만 <IC code="/**/" />는 /*와 */ 사이를 주석으로
          만들어집니다.<br /><br />
        </p>
      </div>
      <iframe
    ...
    <div>
      <div>
        ...
        <p>
          ...
          <IC code="///" />는 코드 블록(예: main()) 서에서
          <IC code="//!" /> 코드 블록 안에서 사용합니다.<br /><br />

          밑의 예시에서는 main() 안에서 ///를 사용했고 박에서 //!를
          사용했습니다.
        </p>
      </div>
      <iframe
