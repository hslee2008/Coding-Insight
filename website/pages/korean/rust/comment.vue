  ...
  <div>
    ...
    <div>
      <div>
        <h2>주석 달기 (한 줄)</h2>
        <p>
          <code v-highlight class="rust ic">//</code>를 사용하면 그 줄에서 이 다음으로 나오는
          모든 글자들은 다 주석으로 변합니다.<br /><br />

          코드를 실행할 때 다 무시되어서 일부 코드를 없에고 일시적으로 실행하고
          싶다면 주석을 사용하면 됩니다.<br /><br />

          밑 화면에서는 Hello World는 주석이어서 출력이 않되고 Hello, World!만
          출력됩니다.
        </p>
      </div>
      <iframe
    ...
    <div>
      <div>
        <h2>주석 달기 (블록 줄)</h2>
        <p>
          <code v-highlight class="rust ic">//</code>는 그 줄에서 이 다음으로 나오는 모든
          글자들은 다 주석으로 만들지만 <code v-highlight class="rust ic">/**/</code>는 /*와 */
          사이를 주석으로 만들어집니다.
        </p>
      </div>
      <iframe
    ...
    <div>
      <div>
        <h2>주석 달기 (DOC 주석)</h2>
        <p>
          <code v-highlight class="rust ic">///</code>와 <code v-highlight class="rust ic">//!</code>는 //와
          똑같지만
          ...
          <code v-highlight class="rust ic">///</code>는 코드 블록(예: main()) 서에서
          <code v-highlight class="rust ic">//!</code> 코드 블록 안에서 사용합니다.<br /><br />
