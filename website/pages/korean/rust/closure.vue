<template>
  <div>
    ...
    <div>
      <div>
        <h2>클로져란?</h2>
        클로져는 함수의 또 다른 종류인데 이름이 없는 함수입니다.<br /><br />

        쉽게 말하자면 클로져는 함수를 한 번 사용할 때 이용하는 함수입니다.<br /><br />

        그래서 함수는 다시 원하는 만큼 사용할 수 있지만 클로져는 한 번만 사용할
        수 있습니다.<br /><br />
      </div>
    </div>
    ...
    <div>
      <div>
        <h2>클로져</h2>
        || 사이에 함수 input을 놓고 output은 || 다음에 넣으면 자동으로 반환됩니다.<br /><br />
