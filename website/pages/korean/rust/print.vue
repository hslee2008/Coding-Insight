<template>
  <div>
    ...
    <div>
      ...
      <iframe
        :src="`${playrust}fn%20main()%20%7B%0A%20%20%20%20println!(%22Hello%2C%20world!%22)%3B%0A%7D`"
        width="100%"
        height="400"
      />
      <div>
    ...
    <div>
      <div>
        <h2>main()이란?</h2>
        <p>
          코딩 언어에서 <code class="ic">main()</code>이라는 것을 "함수"라고
          부릅니다. <br /><br />
      ...
      <iframe
        :src="`${playrust}println!(%22Hello%2C%20world!%22)%3B`"
        width="100%"
        height="400"
      />
      <div>
