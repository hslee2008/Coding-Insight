<template>
  <div>
    ...
    <BasicExpDivWithOneIframe
      heading="while 문"
      :contents="[
        'while 문이란 loop 문과 비슷하지만, 조건을 만족할 때만 실행합니다.',
        'while이라는 키워드 다음에 불리언을 넣어서 불리언이 true일 때 까지 반복합니다.',
        '즉, while true는 무한 반복을 말합니다.',
      ]"
    ...
    <BasicExpDivWithOneIframe
      heading="break와 continue 키워드"
      :contents="[
        'break를 사용하면 loop에서와 마찬가지로 while 문을 멈춥니다.',
        '그리고 continue를 사용하면 반복문을 계속하는데 다음 단계',
        '(더 while 문 코드가 있으면 무시하고 다음으로 while 문 코드로 넘어가기).',
      ]"
