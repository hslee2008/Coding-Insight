  ...
  <div>
    ...
    <div style="display: flex" class="img-div">
      <div style="margin: auto">
        ...
        <p>
          ...
          사실 다른 코딩 언어는 캐릭터를 저장하는데 1 BYTE (8bit)를 사용하는데, Rust는 사실 4 BYTE를 이용합니다.<br /><br />
    ...
    <div>
      <div>
        ...
        위에서 설명했듯이 Rust는 4 BYTE를 사용하는데, 이는 아스키 코드값을 저장하는데 사용됩니다.<br /><br />

        아스키 코드란 문자를 컴퓨터가 효율적으로 저장하기 위해서 사용하는 코드(숫자)를 의미합니다.<br /><br />
