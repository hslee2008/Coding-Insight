  ...
  <div>
    ...
    <div>
      <div>
        <h2>{} 코드 블록</h2>
        <p>
          {} 코드 블록 안에서 만든 변수는 {} 안에서만 사용할 수 있습니다.<br /><br />

          이런 변수를 지역 변수라고 합니다.<br /><br />
    ...
    <div>
      <div>
        <h2>그림자</h2>
        <p>
          변수의 "새로운 그림자 변수"는 변수 범위가 다른 곳에서 똑같은 이름을
          만든 것입니다.<br /><br />

          예를 들면, lang 변수 안에 "Rust" 값을 저장하고 {} 코드 블록 안에
          "Python"이라고 따로 저장하면 {} 안에서는 "Python" 값을 가지고 있고
          밖에서는 "Rust"를 가지고 있습니다.
        </p>
      </div>
      <div>
        <iframe
