<template>
  <div>
    ...
    <div style="display: flex" class="img-div">
      <div style="margin: auto">
        ...
        <p>
          ...
          어디에서 변수가 만들어지었는지가 중요한데요 <IC code="{}" /> (코드
          블록) 안에서만 작동하는 변수와 글로벌 변수가 있습니다.<br /><br />

          예: <IC code="main() {}" /> 함수 안에서는 main이만 사용할 수 있고
          밖에서 선정하면 모든 파일에서 사용할 수 있습니다.
        </p>
      </div>
      <div style="margin: auto">
        <CIImage
    ...
    <BasicExpDivWithOneIframe
      ...
      :contents="[
        'CODE:{}',
        ' 코드 블록 안에서 만든 변수는 괄호 안에서만 사용할 수 있습니다.',
        '이런 변수를 지역 변수라고 합니다.',
