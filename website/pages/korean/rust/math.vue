<template>
  <div>
    ...
    <BasicExpDivWithOneIframe
      heading="pow, powf, sqrt 메서드"
      :contents="[
        '숫자에 pow(x) 메서드를 실행하면 x만큼 그 값을 곱하게 됩니다.',
        '참고로 x의 값은 소수가 되면 루트의 값도 찾을 수 있습니다. 소수를 넣고 싶으면 powf()를 사용하세요.',
    ...
    <BasicExpDivWithOneIframe
      ...
      iframe="https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&code=fn%20main()%20%7B%0D%0A%20%20%20%20let%20test_integer%3A%20i32%20%3D%20-4%3B%0D%0A%20%20%20%20%0D%0A%20%20%20%20println!(%22%7B%7D%22%2C%20test_integer.abs())%3B%0D%0A%7D"
    />
