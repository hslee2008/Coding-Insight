<template>
  <div>
    ...
    />
    <p>A new box will appear and click on it.</p>

    <v-img
      src="https://image-loader-coding-insight.web.app/py-en/img/agree.jpg"
    />
    <p>Click on agree and click the next button.</p>
    ...
    />
    <p>Press on <kbd>CTRL + SHIFT + X</kbd> or press the cube button</p>

    <v-img
      src="https://image-loader-coding-insight.web.app/py-en/img/input.jpg"
    />
    <p>Type in "Python" in the input</p>
    ...
    />
    <p>Type in code runner and click on the green button, again</p>
    ...
    />
    <p>Press <kbd>CTRL + SHIFT + E</kbd> or click on the file icon</p>

    <v-img
      src="https://image-loader-coding-insight.web.app/py-en/img/choose.jpg"
    />
    <p>Click on the blue "Select Folder" button</p>

    <v-img
      src="https://image-loader-coding-insight.web.app/py-en/img/background.jpg"
    />
    <p>
      Click on the folder you want your code to be. If you don't know what I am
      talking about, just select Desktop.
    </p>

    <v-img
      src="https://image-loader-coding-insight.web.app/py-en/img/newfile.jpg"
    />
    <p>Click on the 'new file' button</p>

    <v-img
      src="https://image-loader-coding-insight.web.app/py-en/img/filename.jpg"
    />
    <p>Set you file name ending with '.py'</p>
    ...
    <p>
      Type in
      <code v-highlight class="python">print("hello world")</code>, click on the
    ...
    />
    <p>Check out your first program 기</p>
