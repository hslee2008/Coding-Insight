<template>
  <div>
    <Header type="Python" num="31" title="Special Variable" />
    ...
    <div>
      <div>
        ...
        <p>
          ...
          If we want to make a variable that can be used anywhere in a file, use
          the 'global' keyword in front of a variable name.<br /><br />
