...
<iframe
  loading="lazy"
  className="youtube" src="https://www.youtube.com/embed/nJg2uCjwKa4"
...
<Quiz
  quiz={{
    quizTitle: '파이썬 퀴즈 3',
    quizSynopsis: '주석 달기에 대한 파이썬 퀴즈입니다.',
    nrOfQuestions: '1',
    questions: [
      {
        question: '"# print("Hello World")"를 실행하면?',
        questionType: 'text',
        ...
        correctAnswer: '3',
        explanation:
          '주석 안에 있는 것들을 컴퓨터가 무시하기 때문에 코드여도 사실 실행되지 않습니다.',
        point: '100'
      }
    ]
  }}
