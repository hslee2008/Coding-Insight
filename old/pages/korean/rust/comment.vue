  ...
  <div>
    ...
    <div>
      <div>
        <h2>주석 달기 (한 줄)</h2>
        <p>
          <code v-highlight class="rust ic">//</code>를 사용하면 그 줄에서 이
          다음으로 나오는 모든 글자들은 다 주석으로 변합니다.<br /><br />
    ...
    <div>
      <div>
        <h2>주석 달기 (블록 줄)</h2>
        <p>
          <code v-highlight class="rust ic">//</code>는 그 줄에서 이 다음으로
          나오는 모든 글자들은 다 주석으로 만들지만
          <code v-highlight class="rust ic">/**/</code>는 /*와 */ 사이를
          주석으로 만들어집니다.
        </p>
      </div>
      <iframe
    ...
    <div>
      <div>
        ...
        <p>
          ...
          <code v-highlight class="rust ic">///</code>는 코드 블록(예: main())
          서에서 <code v-highlight class="rust ic">//!</code> 코드 블록 안에서
          사용합니다.<br /><br />
