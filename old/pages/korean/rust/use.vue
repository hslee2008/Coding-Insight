<template>
  <div>
    ...
    <div>
      ...
      <code v-highlight class="rust ic">{}</code> 사이에 아이템 이름을 넣으면
      그것을 직접 모듈 이름 사용하지 않고 호출할 수 있었습니다.<br /><br />

      하지만 아이템이 많이 들어있다면
      <code v-highlight class="rust ic">{}</code> 사이에 하나하나 다 넣지 않고
    ...
    <h2>범위</h2>
    <div>
      <code v-highlight class="rust ic">use</code> 키워드를 사용하면 그 다음에
      나오는 모든 코드에서 모듈 이름을 사용하지 않고 그 아이템을 호출할 수
      있습니다.<br /><br />
