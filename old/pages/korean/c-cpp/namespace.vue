    ...
    <div>
      <div>
        ...
        <p>
          ...
          namespace 안에 나만의 코드의 모음을 넣을 수 있습니다.<br /><br />
    ...
    <div>
      <div>
        ...
        <p>
          ...
          `namespace 이름 {}` 형태로 선언을 하고 {} 안에 함수, 클래스 등 넣으면
          됩니다.<br /><br />
      ...
      <iframe title="JDoodle C and CPP" :src="`${jdoodle}4mRF`" height="400" />
    </div>
      ...
      <div>
        ...
        <p>
          ...
          <code v-highlight class="cpp">
            ...
            using namespace functions;<br /><br />
